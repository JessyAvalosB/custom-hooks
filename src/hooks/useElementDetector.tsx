...
export interface Options {
  ...
  rootMargin?: number; // Root margin for intersection ratio
}
  ...
  useEffect(() => {
    ...
    const observer = new IntersectionObserver(
      ...
      },
      {
        ...
        rootMargin: `${options?.rootMargin || 0}px 0px 0px 0px`, // Configure the observer with root margin from options, default to 0
      }
    );
